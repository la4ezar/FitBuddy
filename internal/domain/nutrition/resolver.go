...
func (r *Resolver) GetLogQuery(ctx context.Context, nutritionLogID string) (*Nutrition, error) {
...
func (r *Resolver) UpdateLogMutation(ctx context.Context, input UpdateLogInput) (*Nutrition, error) {
